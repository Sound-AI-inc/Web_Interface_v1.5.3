...
const configs = [
  { host: `${ref}.supabase.co`, port: 5432, database: "postgres", user: "postgres", password: serviceRoleKey, ssl: { rejectUnauthorized: false }, label: "direct-ssl" },
  { host: `${ref}.supabase.co`, port: 5432, database: "postgres", user: "postgres", password: serviceRoleKey, ssl: false, label: "direct-nossl" },
  { host: "aws-0-us-east-1.pooler.supabase.com", port: 6543, database: "postgres", user: `postgres.${ref}`, password: serviceRoleKey, ssl: { rejectUnauthorized: false }, label: "pooler-east1-ssl" },
  { host: "aws-0-us-east-1.pooler.supabase.com", port: 6543, database: "postgres", user: `postgres.${ref}`, password: serviceRoleKey, ssl: false, label: "pooler-east1-nossl" },
  { host: "aws-0-us-west-1.pooler.supabase.com", port: 6543, database: "postgres", user: `postgres.${ref}`, password: serviceRoleKey, ssl: { rejectUnauthorized: false }, label: "pooler-west1-ssl" },
  { host: "aws-0-us-west-1.pooler.supabase.com", port: 6543, database: "postgres", user: `postgres.${ref}`, password: serviceRoleKey, ssl: false, label: "pooler-west1-nossl" },
];
