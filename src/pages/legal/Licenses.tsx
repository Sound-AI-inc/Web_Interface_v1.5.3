    ...
    <section className="section-padding">
      <div className="container-max max-w-4xl">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left py-3 px-4 font-poppins font-semibold text-light-bg/70">Component</th>
                  <th className="text-left py-3 px-4 font-poppins font-semibold text-light-bg/70">Version</th>
                  <th className="text-left py-3 px-4 font-poppins font-semibold text-light-bg/70">License</th>
                  <th className="text-left py-3 px-4 font-poppins font-semibold text-light-bg/70">Source</th>
                </tr>
              </thead>
              <tbody>
                {licenses.map((l) => (
                  <tr key={l.name} className="border-b border-white/5 hover:bg-white/2">
                    <td className="py-3 px-4 text-light-bg/80 font-medium">{l.name}</td>
                    <td className="py-3 px-4 text-light-bg/50 font-mono text-xs">{l.version}</td>
        ...
        <div className="mt-8 card">
          ...
          <p className="text-light-bg/50 text-sm leading-relaxed mb-4">
          ...
          <p className="text-light-bg/50 text-sm leading-relaxed">
