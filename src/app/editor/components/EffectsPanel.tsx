    ...
    <div className="rounded-card border border-surface p-3">
      <div className="mb-3 flex items-center justify-between">
        <div>
          ...
          <div className="mt-1 font-codec text-[11px] text-text/45">
        ...
        <button
          type="button"
          onClick={onToggle}
          className={`inline-flex h-8 min-w-[74px] items-center justify-between rounded-full border px-2.5 transition-colors ${
            enabled
              ? "border-primary/30 bg-primary/10 text-primary"
              : "border-surface bg-surface-muted text-text/45"
          }`}
          aria-pressed={enabled}
        >
          <span className="font-poppins text-[10px] font-semibold uppercase tracking-[0.1em]">
            {enabled ? "On" : "Off"}
          </span>
          <span
