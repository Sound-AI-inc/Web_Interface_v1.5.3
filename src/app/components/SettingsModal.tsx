...
function SettingsCategoryContent({
  ...
  switch (category) {
    case "general":
      return <SettingsContent compact />;
    case "audio":
      return <SettingsContent compact />;
    case "generation":
      return (
    ...
    case "profile":
      return (
        <div className="rounded-card border border-[var(--border-primary)] bg-[var(--surface-primary)] p-6">
          ...
          <button
            type="button"
            className="app-btn-primary mt-4 inline-flex h-9 px-4"
    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between border-b border-[var(--border-primary)] px-6 py-4">
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full border border-[var(--border-primary)] bg-[var(--surface-floating)] text-[var(--text-secondary)] transition-colors hover:text-primary"
        >
          <X className="h-4 w-4" />
        </button>
      </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        <nav className="flex flex-col gap-4 min-w-0 w-[280px] border-r border-[var(--border-primary)] p-4 overflow-y-auto flex-shrink-0">
